            ...
            <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a className= {props.isClick ? "nav-link  text-capitalize a-tag" : "nav-link  text-capitalize active"} href="#/">
                       ...
                       <Button style={{color:"blueviolet"}} onClick={()=>props.setIsClick(false)}>Assignment</Button>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a
                      ...
                      >
                       ...
                       <Button style={{color:"blueviolet"}} onClick={ ()=>props.setIsClick(true)}> Live Session</Button>
                      </a>
                    </li>
                  </ul>
        </div>
