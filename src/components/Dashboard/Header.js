...
const Header = (props) => {
 ...
 const notificationHandler=async()=>{
  ...
  // await axios.post('https://device2api.el.r.appspot.com/client/messages',{email:localStorage.getItem('email')})
  // .then((res1)=>{console.log(res1.data)
    // let noti=res1.data.map((item)=><AddNotify isClick={isClick} key={item._id} date={item.date}  subject={item.subject} />)
                ...
                <div class="dropdown drp-user">
                  ...
                  <div class="dropdown-menu dropdown-menu-right profile-notification">
                    ...
                    <ul class="pro-body">
                      ...
                      <li>
                        {/* <button onClick={clickHandlerLog}><Link to="/SignIn" class="dropdown-item">
