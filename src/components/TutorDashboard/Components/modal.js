...
//   const tutorEmailNotificationToAll=await axios.post("https://device2api.el.r.appspot.com/api/sessions/tutorEmailNotificationToAll")
//   if(tutorEmailNotificationToAll.data){
//     console.log({mailSendToAll:tutorEmailNotificationToAll.data})
//   }
    ...
    <div>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <a href={props?.product?.quesFolderLink}  target ="_blank"  > <Button variant="contained" style={{marginBottom:"30px" }} component="label">
            ...
            <a href={props?.solutionFolderLink}  target ="_blank"  > <Button variant="contained" style={{marginBottom:"30px" }} component="label">
             upload solutions
             
            </Button></a>


            {/* <Button variant="contained" style={{marginBottom:"30px" }} component="label" onClick={handleSendMail}>
           send mail
