      ...
      <nav className={classes["pcoded-navbar"]}  style={{backgroundColor:"#121828"}}>
        <div className={classes["navbar-wrapper"]}>
          <div className={classes["navbar-brand"] && classes["header-logo"]}  style={{backgroundColor:"#121828"}}>
            <Link to="/tutor_dashboard" className={classes["b-brand"]}>
              <div class="b-bg">
          ...
          <div className={classes["navbar-content"] && classes["scroll-div"]}>
            <ul className={classes["pcoded-inner-navbar"]}>
              ...
              <li
                ...
                style={{width:"229%"}}
                className={
                  props.itsClicked === "session_requests"
                    ? classes["nav-item"] && classes.active
                    : classes["nav-item"]
                }
              >
               
                <Link to="/tutor_dashboard/session_requests" className={classes["nav-link"]}>
                  <span className={classes["pcoded-micon"]}>
              ...
              >
                ...
                <Link to="/tutor_dashboard/history" className={classes["nav-link "]}   >
                <span className={classes["pcoded-micon"]}>
              ...
              >
                <Link to="/tutor_dashboard/upcomingSessions" className={classes["nav-link "]} >
                <span className={classes["pcoded-micon"]}>
              ...
              >
                <Link to="/tutor_dashboard/account" className={classes["nav-link "]}>
                <span className={classes["pcoded-micon"]}>
              ...
              <li
                ...
                style={{width:"229%"}}
                className={
                  props.itsClicked === "payment"
                    ? classes["nav-item"] && classes.active
                    : classes["nav-item "]
                }
              >
                <Link to="/tutor_dashboard/payment" className={classes["nav-link "]}>
                <span className={classes["pcoded-micon"]}>
              ...
              >
                <Link to="/tutor_dashboard/settings" className={classes["nav-link "]}>
                <span className={classes["pcoded-micon"]}>
                    <i class="fa fa-cog"></i>
                  </span>
                  <span style={{ fontSize: "17px" }} className={classes["pcoded-mtext"]}>
              ...
              <li data-username="Disabled Menu"  style={{paddingLeft:"20px",paddingTop:"12px", width:"229%", marginTop: "calc(100vh - 480px)"}} className={classes["nav-link disabled"]}>
