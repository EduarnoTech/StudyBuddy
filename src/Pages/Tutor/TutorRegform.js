...
console.log("enmail",enEmail)
  const tutor_reg = async () => {
    ...
    const tutorSave = await axios.post(
      "https://device6chatapi.el.r.appspot.com/api/tutor/regForm_tutor",formdata
  ...
  useEffect(()=>{
    ...
    const findEmail = await axios.post(
      "https://device2api.el.r.appspot.com/tutor/findEmail",{email:props.enteredEmail}
    );
  ...
  //    const find_tutorId= await axios.post("https://device2api.el.r.appspot.com/tutor/tutorSignUp", {email})
  // }
